 ...
 */
@Entity
@Table(name="matnr_price_arc")
@javax.persistence.SequenceGenerator(name="seq_matnr_price_arc_id",sequenceName="seq_matnr_price_arc_id",allocationSize=1)

public class MatnrPriceArc implements Serializable {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator="seq_matnr_price_arc_id")
	private Long mp_id;
	private Long matnr;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MatnrPriceArc other = (MatnrPriceArc) obj;
		if (bukrs == null) {
			if (other.bukrs != null)
				return false;
