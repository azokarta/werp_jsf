...
@ManagedBean(name = "hrDocTransferBean")
@ViewScoped
public class HrDocTransfer implements Serializable {
	...
	private void loadOrBlankDocument() {
		if (MODE_CREATE.equals(mode)) {
			document = new HrDoc();
			document.setTypeId(HrDoc.TYPE_TRANSFER);
